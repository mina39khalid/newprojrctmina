...
class sweet extends StatefulWidget {
   ...
   final String Numsweet;
  final String Pointsweet;
  final String sweett;
  final String Numsweet2;
  final String textsweet2;
                ...
                Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        widget.textsweet2,textAlign: TextAlign.right,
                        style:
                    ...
                    Row(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text("${widget.Numsweet2}",style: TextStyle(fontSize: 30,color: Colors.black),textAlign: TextAlign.right,),
                        ),
                      ],
                    ),
                  ],
